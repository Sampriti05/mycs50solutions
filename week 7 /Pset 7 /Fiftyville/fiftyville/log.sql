...
-- Checking the description of the crime based on location and time.
SELECT description FROM crime_scene_reports
 WHERE year = 2021 AND month = 7 AND day = 28 AND street = 'Humphrey Street';

-- Two incidents happened that day. One being littering and the other related to theft
...
-- Finding names of the 3 witnesses from the list of names of people who gave interviews on July 28, 2021. Crime report said that the witnesses mentioned "bakery" in their transcripts.Results ordered alphabetically by the names of witnesses.
SELECT name, transcript FROM interviews
...
-- Raymond gave clues-- when leaving the bakery,  called a person and talked for less than a minute, asked the person on the other end of the call to buy a flight ticket of the earliest flight on July 29, 2021.
...
-- First flight at 8:20 to LaGuardia Airport in New York City (Flight id- 36). This could be the place where the thief went to.
...
-- Bruce is the thief as he is present in all the 4 lists- List of passengers, list of people who did the specific atm transactions, list of people who called, and list of people who drove away in cars from the bakery.
